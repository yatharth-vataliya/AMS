...
@section('content')
	...
	@endif
	<div class="container">
		<form action="{{ route('teacher_registration') }}" method="POST" class="form-horizontal" accept-charset="utf-8" style="color:#8b4513;font-size: 1.2em;">
			@csrf
			...
			<div class="form-group">
				<label class="control-label col-md-4" for="teacher-password-confirmation">Confirm Password</label>
				<div class="col-md-4">
