...
@section('content')
		...
		@endif
		<div class="container">
<form action="{{ route('student_registration') }}" method="POST" accept-charset="utf-8" class="col-md-10" enctype="multipart/form-data" style="color:#8b4513;font-size: 1.2em;">
	@csrf
	...
	<div class="form-group" style="padding:1.5rem;">
		<label class="control-label col-md-6" for="file_upload">
			Upload Your Image:-
		</label>
		<div class="col-md-6" style="margin-left:-8.9em;margin-top:0.2em;">
